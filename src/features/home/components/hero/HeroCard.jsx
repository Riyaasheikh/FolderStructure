...
const HeroCard = () => {
  return (
    <div>
      <Buttons button1={"🏵 Available for Work"} className={"!bg-[#464646]"} />
      <SectionHeading
        title={
          <>
        ...
        subtitle={
          <>
            ...
            <div className="text-left w-full">
              {" "}
              Nam, repellendus minus reprehenderit earum voluptatem ipsum quia
            </div>
            <div className="text-left w-full">
              {" "}
              a accusantium debitis modi qui eaque vel aut.
            </div>
          </>
        }
        titleClassName={
