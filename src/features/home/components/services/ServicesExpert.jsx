  ...
  const servicesContent = (
    <div className="grid grid-cols-4 md:grid-cols-4 gap-2 mt-2 ml-2">
      {[
        ...
        <div
          key={index}
          className="bg-transparent rounded-full py-2 px-5 text-center border border-[#29292a]"
        >
    ...
    <div className="grid grid-cols-6 ">
      {["Figma", "Framer", "Webflow", "HTML", "CSS", "JavaScript"].map(
        (tech, index) => (
          <div
            key={index}
            className="bg-transparent rounded-full py-2 text-center border border-[#29292a]"
          >
        ...
        <div className="w-full mt-4">
          <div className="space-y-6">
            ...
            <div className="space-y-2 text-lg text-gray-300  whitespace-normal">
              ...
              <div className="text-left ">
                {" "}
                user-centric designs. From strategic concepting to polished
                deliverables,
              </div>
              <div className="text-left ">
                {" "}
                every step is crafted to engage your audience and drive real
                results.
              </div>
            </div>
            <div className="pt-4">
              <Buttons
                button1={"Discover My Approach"}
