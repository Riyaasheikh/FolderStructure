...
const TestimonialCard = ({
  ...
  return (
    <div className={`max-w-md border border-[#29292a] rounded-lg  bg-[#1f1f1f]  ${className}`}>
      
      {/* Client Info at the top */}
      <div className="mt-4 ml-3">
        <h3 className="text-white font-semibold">{name}</h3>
        <p className="text-gray-400 text-sm">{role}</p>
      </div>

      {/* SplitColorParagraph for testimonial */}
      <SplitColorParagraph
      ...
      {/* Company and Logo at the bottom */}
