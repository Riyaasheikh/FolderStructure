    ...
    <div className="bg-[#131313] text-white rounded-3xl shadow-2xl overflow-hidden w-full max-w-sm mx-auto lg:max-w-md">
      <div className="p-4 sm:p-6 lg:p-8">
        ...
        <div className="relative bg-[#332c2c] rounded-lg mt-3 min-h-40 sm:min-h-45 lg:min-h-60 flex items-center justify-center overflow-hidden">
          <div ref={trackRef} className="flex gap-3 sm:gap-5 w-max">
            {/* First set */}
            <img 
              className="h-44 w-28 sm:h-56 sm:w-36 lg:h-60 lg:w-full rounded-lg object-cover" 
              src={heroImg2} 
              alt="Excellence" 
            />
            <img 
              className="h-44 w-28 sm:h-52 sm:w-32 lg:h-60 lg:w-full rounded-lg object-cover" 
              src={heroImg3} 
              alt="Excellence 2" 
            />
            <img 
            ...
            <img 
              className="h-48 w-32 sm:h-56 sm:w-36 lg:h-64 lg:w-full rounded-lg object-cover" 
              src={heroImg2} 
