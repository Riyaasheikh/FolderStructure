export const plans = [
  ...
  },
  {
    ...
    description: "Comprehensive support for growing teams and complex builds.",
    price: "$129",
    period: "month",
    features: [
      "Dedicated design resource(s)",
  ...
  },
  {
    ...
    description: "Ideal for early-stage products and tight turnarounds.",
    price: "$49",
    period: "month",
    features: [
